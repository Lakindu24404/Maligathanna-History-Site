...
const translations = {
  si: {
    ...
    welcome_title: '  මාළිගාතැන්න පුරාවිද්‍යා ස්ථානය',
    ...
    help_title: 'මාළිගාතැන්න වෙබ් අඩවිය භාවිතා කරන ආකාරය',
    help_subtitle: '  මාළිගාතැන්න පුරාවිද්‍යා ස්ථානයේ තොරතුරු, සිතියම් සහ ඡායාරූප පහසුවෙන් ගවේෂණය කිරීමට මඟපෙන්වීම.',
    ...
    help_card2_desc: '<strong>\'පිහිටීම\'</strong> කොටසේදී කුරුණෑගල සිට මාළිගාතැන්නට ළඟා වන සම්පූර්ණ කිලෝමීටර් මට්ටමේ ගමන් විස්තරය සහ Google Maps සජීවී සිතියම ලබා ගත හැක.',
    help_card3_title: '3. පුරාවිද්‍යා නටබුන් සහ ගෘහ නිර්මාණ ශිල්පය',
    help_card3_desc: 'අනුරාධපුර යුගයේ <strong>පධානඝර</strong> (ද්විමාලිගා භාවනා ගොඩනැගිලි) සහ <strong>චංකමනාඝර</strong> (සක්මන් මළු) වල සවිස්තර සැලසුම් සහ වාස්තු විද්‍යාත්මක ලක්ෂණ කියවන්න.',
    ...
    help_card5_desc: 'මාළිගාතැන්න අවට පිහිටි <strong>රැස්වෙහෙර, යාපහුව, අරංකැලේ, හත්ථිකුච්චි, රිදී විහාරය සහ ඇතුගල</strong> වැනි ඓතිහාසික ස්ථානවල දුර ප්‍රමාණයන් හා තොරතුරු ගවේෂණය කරන්න.',
    ...
    nearby_title: 'මාළිගාතැන්න අවට නැරඹිය හැකි ස්ථාන',
    nearby_desc: 'කුරුණෑගල දිස්ත්‍රික්කයේ සහ වයඹ පළාතේ මාළිගාතැන්න පුරාවිද්‍යා භූමියට ආසන්නව පිහිටි සුවිශේෂී ඓතිහාසික ආරාම, පර්වත බලකොටු හා සංස්කෘතික උරුම ස්ථාන.',
    nearby_view_map: 'සිතියම සහ ගමන් මඟ',
    nb_res_title: 'රැස්වෙහෙර (ශේෂරුව) රජමහා විහාරය',
    nb_res_dist: 'මාළිගාතැන්නේ සිට ~18 km',
    ...
    nb_yap_dist: 'මාළිගාතැන්නේ සිට ~22 km',
    ...
    nb_ara_dist: 'මාළිගාතැන්නේ සිට ~32 km',
    ...
    nb_hat_dist: 'මාළිගාතැන්නේ සිට ~34 km',
    ...
    nb_rid_dist: 'මාළිගාතැන්නේ සිට ~48 km',
    ...
    nb_ath_dist: 'මාළිගාතැන්නේ සිට ~28 km',
    ...
    hero_title_main: '  මාළිගාතැන්න පුරාවිද්‍යා ස්ථානය',
    hero_title_en: 'මාළිගාතැන්න',
    hero_subtitle: 'අනුරාධපුර යුගයට අයත් පුරාතන ආරණ්‍ය සේනාසන සංකීර්ණය',
    hero_desc: 'වයඹ පළාතේ කුරුණෑගල දිස්ත්‍රික්කයේ පොල්පිතිගම ප්‍රාදේශීය ලේකම් කොට්ඨාශයේ රාවා ඇළ ග්‍රාම නිලධාරී වසමේ පිහිටි ඓතිහාසික හා වාස්තු විද්‍යාත්මක වැදගත්කමකින් යුත් පුරාවිද්‍යා ස්ථානයකි.',
    hero_btn_explore: 'ස්ථානය ගවේෂණය කරන්න',
    hero_btn_gallery: 'ඡායාරූප නරඹන්න',
    hero_img_label: 'පධානඝර ගොඩනැගිල්ල',
    hero_img_sublabel: 'ද්විමාලිගා ආරණ්‍ය ආරාම ව්‍යුහය',
    scroll_down: 'පහළට ගවේෂණය කරන්න',

    /* Glance */
    glance_tag: 'කෙටි සාරාංශය',
    glance_title: 'මාළිගාතැන්න එක බැල්මකින්',
    ...
    location_title: 'මාළිගාතැන්න පිහිටීම සහ ගමන් මාර්ගය',
    location_intro: 'වයඹ පළාතේ කුරුණෑගල දිස්ත්‍රික්කයේ පොල්පිතිගම ප්‍රාදේශීය ලේකම් කොට්ඨාශයේ අංක 369 රාවා ඇළ ග්‍රාම නිලධාරී වසමේ මෙම පුරාවිද්‍යා ස්ථානය පිහිටා ඇත.',
    loc_province: 'පළාත',
    ...
    route_dest: 'මාළිගාතැන්න',
    route_arrive: 'පුරාවිද්‍යා ස්ථානය',

    /* History */
    history_tag: 'ඓතිහාසික තොරතුරු',
    history_title: 'මාළිගාතැන්නේ ඓතිහාසික පසුබිම',
    ...
    evidence_p1: 'පුරාවිද්‍යා සාධක සහ වාස්තු විද්‍යාත්මක ලක්ෂණ අනුව මෙම ස්ථානය <strong>අනුරාධපුර යුගයට</strong> අයත් යැයි සැලකිය හැකිය. පධානඝර ගොඩනැගිලි හා චංකමනාඝර ගෘහ නිර්මාණ ලක්ෂණ මගින් මෙය පැහැදිලි කෙරේ.',
    evidence_p2: 'කෙසේ වෙතත්, <strong>  මාළිගාතැන්න පුරාවිද්‍යා ස්ථානය සම්බන්ධ ලිඛිත සාධක මෙතෙක් හමු වී නොමැත.</strong> එම නිසා ස්ථානයේ ඓතිහාසික පසුබිම ප්‍රධාන වශයෙන් භෞතික නටබුන් සහ වාස්තු විද්‍යා ලක්ෂණ ඔස්සේ අර්ථකථනය කෙරේ.',
    ...
    tradition_title: 'වළගම්බා රජු සහ මාළිගාතැන්න ජනශ්‍රැතිය',
    tradition_p1: '<strong>වළගම්බා රජු</strong> (වට්ටගාමිණී අභය) විසින් මෙම ස්ථානය කරවා භික්ෂූන් වහන්සේලාට පූජා කළ බව ජනප්‍රවාදයේ කියැවේ. මෙම ස්ථානයේ වළගම්බා රජුගේ මාලිගාව තිබේ යැයි ගැමියන් විශ්වාස කරන අතර <strong>"මාළිගාතැන්න"</strong> ලෙස මෙම ස්ථානය හඳුන්වා ඇත්තේ එබැවිනි.',
    ...
    tradition_note: 'වැදගත් සටහන: මෙම ස්ථානය ආශ්‍රිතව රාජකීය මාලිගාවක් පැවැති බවට පුරාවිද්‍යාත්මක සාධක හමු නොවේ. මෙය දේශීය ජනප්‍රවාදගත විශ්වාසයකි. පුරාවිද්‍යා සාධක අනුව මෙම ස්ථානය ආරාමික සංකීර්ණයක් ලෙස හදුනා ගෙන ඇත.',
    ...
    monastery_p2: 'පධානඝරය, ස්වාභාවික දිය අගල්, සක්මන් භාවනා ශාලාව (චංකමනාඝරය) සහ වනගත නිස්කලංක පිහිටීම පැරණි ශ්‍රී ලංකාවේ ආරණ්‍ය සේනාසන සම්ප්‍රදායේ සියලුම ප්‍රධාන ලක්ෂණ මනාව පිළිබිඹු කරයි.',

    /* Remains */
    remains_tag: 'හඳුනාගත් නටබුන්',
    remains_title: 'පුරාවිද්‍යාත්මක නටබුන්',
    ...
    remain_patana: 'පධානඝර ගොඩනැගිල්ල',
    remain_patana_detail: 'ද්විත්ව වේදිකා සහිත මෙම ගොඩනැගිල්ල ආරණ්‍යවාසී භික්ෂූන්ගේ භාවනා කටයුතු උදෙසා නිර්මාණය කර ඇත. පිටත මණ්ඩපය හා අභ්‍යන්තර කුටිය ශිලා පාලමකින් සම්බන්ධ වන අතර ඉහළ ගොඩනැගිල්ල වටා ස්වාභාවික දිය අගලක් පිහිටා තිබේ. පුරාවිද්‍යා දෙපාර්තමේන්තුව මගින් සංරක්ෂණය කර ඇත.',
    ...
    remain_steps_con_detail: 'ගලෙහි කර නිමවන ලද මනරම් පියගැටපෙළ සහ සඳකඩපහණ සහිත ප්‍රවේශ මාර්ග. වේදිකා සහ මණ්ඩප අතර පහසු ගමනාගමනය සලසයි.',
    ...
    patana_label: 'පධානඝරය',
    chanka_label: 'චංකමනාඝරය',
    patana_title: 'පධානඝර ගොඩනැගිල්ල',
    ...
    patana_desc2: 'ද්විත්ව වේදිකා සහිත ගෘහ නිර්මාණ ශෛලිය මෙහි ප්‍රධාන ලක්ෂණයයි. මෙහි පිටත මණ්ඩපය (Outer Mandapa) සහ අභ්‍යන්තර කුටිය (Inner Chamber) යන වේදිකා ද්විත්වය දැවැන්ත ඒකශිලා පාෂාණ පාලමකින් (Stone Slab) එකිනෙක සම්බන්ධ කර ඇත.',
    ...
    patana_conserved: 'පධානඝරය ආරක්ෂිත පුරාවිද්‍යාත්මක ස්මාරකයක් ලෙස ප්‍රකාශයට පත් කර සංරක්ෂණය කර ඇත.',
    ...
    chanka_desc2: 'මාළිගාතැන්නේ චංකමනාඝර ගොඩනැගිල්ල <strong>1998 වසරේදී පුරාවිද්‍යා දෙපාර්තමේන්තුව මගින් කැනීම් කර සංරක්ෂණය කරන ලදී</strong>.',
    ...
    chanka_feature3: 'පුරාවිද්‍යා දෙපාර්තමේන්තුවේ අධීක්ෂණය යටතේ ස්ථීර වැඩබිමක් ලෙස පවත්වාගෙන යයි',
    other_feat_title: 'අනෙකුත් වාස්තු විද්‍යාත්මක ලක්ෂණ',
    feat_stairway: 'ගල් පියගැට සහ සඳකඩපහණ',
    feat_stairway_desc: 'පියගැටපෙළ සහ ආරාධනාත්මක සඳකඩපහණ',
    feat_walls: 'ආරක්ෂිත ගල් බැමි',
    feat_walls_desc: 'ද්විත්ව ස්ථරවලින් යුතු ශක්තිමත් පාෂාණ බැමි',
    feat_gateway: 'ඉහල වේදිකාව',
    feat_gateway_desc: 'ඒකශිලා පාෂාණයෙන් නිර්මිත පාලම් ගල',
    feat_entry: 'වේදිකා ප්‍රවේශ මාර්ග',
    feat_entry_desc: 'සක්මන් මළුව',

    /* Timeline */
    timeline_tag: 'ඓතිහාසික ගමන්මග',
    timeline_title: 'මාළිගාතැන්න කාලරේඛාව',
    ...
    tl_desc4: 'සිදු කරන ලද පුරාවිද්‍යාත්මක ගවේෂණ මගින් අක්කර 27ක් පුරා විසිරී තිබූ පධානඝර, චංකමනාඝර, පොකුණු, පියගැට ආදී නටබුන් හඳුනාගැනීම.',
    tl_period5: '1998 වසර',
    ...
    tl_desc6: 'සංරක්ෂිත පධානඝර සහ චංකමනාඝර ගොඩනැගිලි ශ්‍රී ලංකා පුරාවිද්‍යා පනත යටතේ ආරක්ෂිත ස්මාරක බවට පත් කිරීම.',
    tl_period7: 'වර්තමානය',
    ...
    gallery_title: 'මාළිගාතැන්න දසුන්',
    ...
    gcap_02: 'පධානඝර ගොඩනැගිල්ල — ගුවන් දසුන',
    gcap_03: 'ගල් පියගැට සහ සඳකඩපහණ',
    gcap_04: 'මාළිගාතැන්න පරිශ්‍රය — පුළුල් ගුවන් දසුන',
    gcap_05: 'ඉහළ වේදිකාවට පිවිසෙන ගල් පියගැට',
    gcap_06: 'චංකමනාඝරය — අභ්‍යන්තර සක්මන් මාර්ගය',
    gcap_07: 'ගල් බැම්ම සහ දොරටු මුහුණත',
    gcap_08: 'පධානඝර පිටත ආරක්ෂිත ගල් බැම්ම',
    gcap_09: 'පධානඝර ඉහළ වේදිකාව',
    ...
    gcap_18: 'පධානඝර දිය අගල සහ ශිලා පාලම',
    gcap_19: 'ප්‍රවේශ මණ්ඩපය, ශිලා උළුවස්ස සහ පියගැට පෙළ',
    gcap_20: 'අභ්‍යන්තර මළුව සහ සඳකඩපහණ සහිත පියගැට පෙළ',
    gcap_21: 'පධානඝර උස් ශිලා වේදිකාව සහ පාදම් බැම්ම',
    gcap_22: 'ශිලා කුළුණු පාදම් සහිත ඉහළ මළුව',
    gcap_23: 'ප්‍රවේශ ශිලා උළුවස්ස සහ පාමුල සඳකඩපහණ',
    ...
    pres_intro: 'මාළිගාතැන්නේ පුරාවිද්‍යාත්මක වටිනාකම හෙළිදරව් කර සංරක්ෂණය කිරීමේ ගමන්මග.',
    pres_img_cap: 'සංරක්ෂිත පධානඝර ගල් බැමි — මාළිගාතැන්න',
    ...
    pres_1998_desc: 'පධානඝරය සහ චංකමනාඝරය සංරක්ෂණය කරන ලදී. විශේෂයෙන් චංකමනාඝරය 1998 වසරේදී කැනීම් කර විද්‍යාත්මකව සංරක්ෂණය කෙරිණි.',
    ...
    dyk_2: 'පධානඝරය පිටත මණ්ඩපයකින් සහ ඇතුළත කුටියකින් යුත් සුවිශේෂී <strong>ද්විමාලිගා ගෘහ නිර්මාණ ශෛලියකින්</strong> සමන්විත වේ.',
    dyk_3: 'පධානඝරයේ ඉහළ ගොඩනැගිල්ල වටා <strong>ස්වාභාවික දිය අගලක්</strong> පිහිටා තිබේ.',
    dyk_4: 'චංකමනඝරය <strong>1998 වර්ෂයේදී</strong> පුරාවිද්‍යා දෙපාර්තමේන්තුව මගින් කැනීම් කර සංරක්ෂණය කරන ලදී.',
    dyk_5: 'පධානඝරය අසලින් හමු වූ <strong>උළු කැබලි</strong> මගින් මෙම ගොඩනැගිලි මුලින් වහලයකින් ආවරණය වී තිබූ බව තහවුරු වේ.',
    ...
    content_credit: 'අන්තර්ගතය සකස් කළේ: <strong>ඩී. ඩබ්ලිව්. නෙළුම් චතුරිකා රුක්මාලි</strong> (ස්ථානභාර නිලධාරීනී, නාගොල්ල සහ   මාළිගාතැන්න පුරාවිද්‍යා ස්ථාන)',
    ...
    footer_copy: '© 2026 මාළිගාතැන්න පුරාවිද්‍යා උරුම ස්ථානය. සියලු හිමිකම් ඇවිරිණි.',
  ...
  en: {
    ...
    remain_other_detail: 'Additional archaeological remains have been identified across the 27-acre site, including roof tile fragments near the Padhanagharaya that confirm the structures originally had roofs.',
    learn_more: 'Learn More',

    /* Architecture */
    arch_tag: 'Major Structures',
    arch_title: 'Key Architectural Features',
    patana_label: 'Padhanagharaya',
    chanka_label: 'Chankamanaghara',
    patana_title: 'Padhanagharaya',
    ...
    patana_conserved: 'The Padhanagharaya has been conserved and declared a protected monument.',
    ...
    tl_desc6: 'The conserved Padhanagharaya and Chankamanaghara were declared protected monuments under Sri Lankan archaeological preservation law.',
    tl_period7: 'Present',
    ...
    gcat_patana: 'Padhanagharaya',
    gcat_nature: 'Nature',
    gcap_01: 'Chankamanaghara — Aerial View',
    gcap_02: 'Padhanagharaya — Aerial View',
    ...
    gcap_09: 'Padhanagharaya — Upper Platform',
    ...
    gcap_18: 'Moat and Connecting Stone Bridge of Padhanaghara',
    gcap_19: 'Entrance Pavilion, Stone Doorway and Stairway',
    gcap_20: 'Inner Courtyard and Stone Steps with Moonstone',
    gcap_21: 'Elevated Stone Terrace and Foundation Wall',
    gcap_22: 'Upper Terrace with Stone Pillar Bases',
    gcap_23: 'Monolithic Entrance Doorframe and Moonstone',
    ...
    pres_1998_desc: 'The Padhanagharaya and Chankamanaghara were conserved. The Chankamanaghara was specifically excavated and conserved in 1998.',
    ...
    dyk_2: 'The Padhanagharaya has a distinctive <strong>double-platform</strong> architecture with an outer mandapa and inner chamber.',
    dyk_3: 'A <strong>natural water channel</strong> surrounds the upper building of the Padhanagharaya.',
    dyk_4: 'The Chankamanaghara was <strong>excavated and conserved in 1998</strong> by the Department of Archaeology.',
    dyk_5: '<strong>Roof tile remains</strong> near the Padhanagharaya confirm the structures originally had roofs.',
  ...
  ta: {
    ...
    gcap_18: 'பாட்டான஘ர அகழி மற்றும் கல் பாலம்',
    gcap_19: 'நுழைவு மண்டபம், கல் வாயில் மற்றும் படிகள்',
    gcap_20: 'உட்புற முற்றம் மற்றும் நிலவுக்கல்லுடன் கூடிய படிகள்',
    gcap_21: 'உயர்த்தப்பட்ட கல் மேடை மற்றும் அடித்தள சுவர்',
    gcap_22: 'கல் தூண் தளங்களுடன் கூடிய மேல் மேடை',
    gcap_23: 'நுழைவு கல் வாயில் சட்டம் மற்றும் நிலவுக்கல்',
...
const galleryImages = [
  ...
  { src: 'assets/images/img18-stone-bridge-moat.jpg', category: 'stone patana', titleKey: 'gcap_18', catKey: 'gcat_stone' },
  { src: 'assets/images/img19-entrance-gateway-front.jpg', category: 'stone patana nature', titleKey: 'gcap_19', catKey: 'gcat_stone' },
  { src: 'assets/images/img20-inner-courtyard-moonstone.jpg', category: 'stone patana', titleKey: 'gcap_20', catKey: 'gcat_stone' },
  { src: 'assets/images/img21-platform-retaining-wall.jpg', category: 'stone patana nature', titleKey: 'gcap_21', catKey: 'gcat_patana' },
  { src: 'assets/images/img22-upper-terrace-pillar-bases.jpg', category: 'stone patana nature', titleKey: 'gcap_22', catKey: 'gcat_patana' },
  { src: 'assets/images/img23-stone-doorway-facade.jpg', category: 'stone patana', titleKey: 'gcap_23', catKey: 'gcat_stone' }
];
...
function cleanTextForSpeech(text, lang) {
  ...
  if (lang === 'si') {
    ...
    s = s.replace(/GN Division No\.\s*369/gi, 'අංක 369 රාවා ඇළ ග්‍රාම නිලධාරී වසම');
