...
const translations = {
  si: {
    ...
    pres_img_cap: 'සංරක්ෂිත පඨානඝර ගල් බැමි — මාළිගාතැන්න',
    ...
    content_credit: 'අන්තර්ගතය සකස් කළේ: <strong>ඩී. ඩබ්ලිව්. නෙළුම් චතුරිකා රුක්මාලි</strong> (ස්ථානභාර නිලධාරීනී, නාගොල්ල සහ මාළිගාතැන්න පුරාවිද්‍යා ස්ථානය)',
